...
class Debuglet extends events_1.EventEmitter {
    ...
    static findFiles(shouldHash, baseDir) {
        return __awaiter(this, void 0, void 0, function* () {
            const fileStats = yield scanner.scan(shouldHash, baseDir, /.js$|.js.map$/);
    ...
    start() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let findResults;
            try {
                findResults = yield Debuglet.findFiles(!id, that.config.workingDirectory);

...
function processSourcemap(infoMap, mapPath) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        sources.forEach((src) => {
            infoMap.set(path.normalize(src), { outputFile: outputPath, mapFile: mapPath, mapConsumer: consumer });
        });
    });
}
class SourceMapper {
    ...
    mappingInfo(inputPath, lineNumber, colNumber) {
        ...
        const mappedPos = allPos && allPos.length > 0 ?
            Array.prototype.reduce.call(allPos, (accumulator, value /*, index, arr*/) => {

...
CircularJSON.stringify = function stringify (data, replacer, space) {
  try {
    return arguments.length === 1
      ? JSON.stringify(data)
      : JSON.stringify(data, replacer, space)
  } catch (e) {
    return CircularJSON.stringifyStrict(data, replacer, space)
  }
}

CircularJSON.parse = function parse (data, reviver) {
...
CircularJSON.stringifyStrict = function stringifyStrict (data, replacer, space) {
  var list = []

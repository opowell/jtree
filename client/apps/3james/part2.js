...
stage.content = `
    <span jt-displayif='player.treatment==1'>
        ...
        If a participant chose Option B, he/she would receive {{app.payoff_a}} Euros if the participant with whom they were matched also chose Option B, and nothing if the participant with whom they were matched also chose Option A.</p>
        </p>

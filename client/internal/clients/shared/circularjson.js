...
jt.stringify = function(data, replacer, space) {
  try {
    return arguments.length === 1
      ? JSON.stringify(data)
      : JSON.stringify(data, replacer, space)
  } catch (e) {
    return jt.stringifyStrict(data, replacer, space)
  }
}

jt.parse = function(data, reviver) {
...
jt.stringifyStrict = function(data, replacer, space) {
  var list = []

...
jt.defaultConnected = function() {
    ...
    jt.socket.on('setAutoplay', function(d) {
        d = Flatted.parse(d);
        if (jt.vue.player !== undefined && d.participantId === jt.vue.player.id) {
